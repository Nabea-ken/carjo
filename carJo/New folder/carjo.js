...
function openModal(car) { modal.style.display = 'flex'; modalImage.src = car.img; modalTitle.textContent = ${car.brand} ${car.model}; modalDesc.textContent = car.desc; modalPrice.textContent = $${car.price}; }
...
function addToCart() { alert("Car added to cart!"); }
